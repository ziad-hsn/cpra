---
title: Candidate · Durable CPRa candidate
description: Candidate · Implemented durability and operator interfaces, completed checks, and outstanding release evidence.
...
These guides publish the candidate documentation for review. Its application code remains separate from `main`; application release qualification is still open. Current main is [51a835a](https://github.com/ziad-hsn/cpra/commit/51a835a29f2fb7af2e0301910042a52e308cbb24).
