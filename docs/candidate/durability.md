---
title: Candidate · Persistence and restart recovery
description: Candidate · Persistence and restart recovery for the reviewed CPRa source; see the version and availability notice.
