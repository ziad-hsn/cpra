---
title: Candidate · Worker sizing and queueing
description: Candidate · The runtime Erlang C and Allen–Cunneen model, observed variability, headroom, fallback and capacity limits in CPRa.
...
The candidate adds a 30-second feedback window evaluated every five seconds, with at least 1,000 observations. Queue delay can request bounded growth; slow execution and controller-limited work are reported separately. Shrinking requires 60 healthy seconds, is capped at 10% per adjustment, and stays above the model recommendation. The five-minute measured report is separate from this control window. See [measured latency](../slo.md).
...
[Runtime implementation](https://github.com/ziad-hsn/cpra/blob/410fbfb0092d01277b3884cd04151c27443a4226/internal/queue/dynamic_worker_pool.go) · [Sizing mathematics](https://github.com/ziad-hsn/cpra/blob/410fbfb0092d01277b3884cd04151c27443a4226/internal/queue/sizing.go)
