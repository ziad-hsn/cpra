---
title: Candidate · Add a check or action
description: Candidate · Extend CPRa through schema, execution and verification while respecting contexts and incident ownership.
