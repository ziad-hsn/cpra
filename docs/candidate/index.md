---
title: Candidate · CPRa documentation
description: Candidate · Run CPRa to check services, send alerts and perform configured recovery actions. Start with the current Go application, dashboard and CLI.
