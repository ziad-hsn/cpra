---
title: 'Plan and status · 03-history: Retain monitor event history'
description: 'Plan and status · 03-history: Retain monitor event history for the reviewed CPRa source; see the version and availability notice.'
cpra_scope: plan
---
