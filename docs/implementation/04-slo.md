---
title: 'Plan and status · 04-slo: Add percentile SLO control'
description: 'Plan and status · 04-slo: Add percentile SLO control for the reviewed CPRa source; see the version and availability notice.'
cpra_scope: plan
---
