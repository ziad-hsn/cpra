// Package fleetview holds the read-only, point-in-time projection of CPRA
...
type MonitorSummary struct {
	CheckAdmission      string    `json:"check_admission,omitempty"`
	MissedChecks        uint64    `json:"missed_checks"`
