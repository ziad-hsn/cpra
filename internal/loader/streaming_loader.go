...
// LoadingStats holds loading statistics
...
// DefaultStreamingConfig returns the default parser and entity-loading configuration
...
func (sl *StreamingLoader) Load(ctx context.Context) (*LoadingStats, error) {
	...
	entityCreator := NewStreamingEntityCreator(sl.world, EntityCreationConfig{
		...
		MaxWorkers:   sl.config.MaxWorkers,
