...
The module includes its [MIT license](LICENSE). Source and package documentation
...
See the executable local HTTP fixture in [example_test.go](example_test.go) to
...
requests use opaque source tokens. See the [collection guide](collection/README.md)
...
the missing suffix. See the [collection guide](collection/README.md#file-profiles-and-recovery-after-restart)
...
are provisioned through [stopped local administration](../../docs/worker-authentication.md).
...
[publishing guide](../../docs/sdk/publishing.md), including the separate nested
