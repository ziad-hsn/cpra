...
The parent [SDK README](../README.md) describes candidate versions and current
server API support.
...
Try [example_test.go](example_test.go) for complete programs that freeze either
...
[example_reselection_test.go](example_reselection_test.go) for a runnable local
